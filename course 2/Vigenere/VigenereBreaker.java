...
public class VigenereBreaker {
    ...
    public void breakVigenere () {
        ...
        FileResource po = new FileResource("dictionaries/Portuguese");
        ...
        languages.put("Portuguese",readDictionary(po));
        ...
        breakForAllLangs(file.asString(),languages);
    ...
    public void breakForAllLangs(String encrypted,HashMap<String,HashSet<String>> languages){
        ...
        int count = countWords(encrypted,languages.get(lan));
